        ...
        return content
            ...
            .map((line, i) => {
                ...
                if (line.startsWith('### ')) {
                    ...
                    const id = text.toLowerCase().replace(/\s+/g, '-');
                    return (
                        <h3 id={id} key={i} className="text-base md:text-xl font-bold text-gray-900 mt-6 md:mt-8 mb-3 md:mb-4 tracking-tight">
                            {text}
                        </h3>
                    );
                }
                if (line.startsWith('## ')) {
                    ...
                    const id = text.toLowerCase().replace(/\s+/g, '-');
                    return (
                        <h2 id={id} key={i} className="text-lg md:text-2xl font-black text-gray-900 mt-8 md:mt-10 mb-4 md:mb-5 tracking-tight border-b-2 border-dashed border-gray-100 pb-2">
                            {text}
                        </h2>
                    );
                }
                if (line.startsWith('# ')) {
                    ...
                    const id = text.toLowerCase().replace(/\s+/g, '-');
                    return (
                        <h1 id={id} key={i} className="text-xl md:text-3xl font-black text-gray-900 mt-6 md:mt-8 mb-4 md:mb-6 tracking-tight">
                            {text}
                        </h1>
                    );
                }
        ...
        <div className="space-y-4 md:space-y-6 animate-fade-in max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-1 order-2 lg:order-1 flex flex-col gap-4 md:gap-6 lg:h-[calc(100vh-140px)] overflow-y-auto">
                    {/* TOC */}
                    <div className="bg-white rounded-lg p-4 md:p-6 shadow-sm border-2 border-dashed border-gray-200 transition-all duration-300">
                        <button
                        ...
                        {isTocExpanded && (
                            <nav className="space-y-2 md:space-y-3 mt-3 md:mt-4 animate-accordion-down max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div className="lg:col-span-3 order-1 lg:order-2">
                    <div className="bg-white rounded-lg shadow-sm border-2 border-dashed border-gray-200 flex flex-col lg:h-[calc(100vh-140px)] overflow-hidden">
                        {/* Header */}
                        <div className="flex-none p-4 md:p-8 border-b-2 border-dashed border-gray-100 bg-white">
