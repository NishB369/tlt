                        ...
                        <div className="relative aspect-video bg-gray-900">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center group">
                                <div className="text-center">
                                    <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-3 md:mb-4 rounded-xl bg-white/10 flex items-center justify-center cursor-pointer hover:bg-white/20 transition-all active:scale-95 backdrop-blur-sm border border-white/5">
                                        {isPlaying ? (
                                    ...
                                    <p className="text-white/60 text-[10px] md:text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                                {/* Progress Slider */}
                                <div className="relative h-1 md:h-1.5 bg-white/20 rounded-full mb-4 md:mb-6 cursor-pointer group hover:h-1.5 md:hover:h-2 transition-all">
                                    <div
                                        className="absolute inset-y-0 left-0 bg-accent-500 rounded-full"
                                        style={{ width: `${progress}%` }}
                                    />
                                    <div
                                        className="absolute top-1/2 -translate-y-1/2 w-3 h-3 md:w-4 md:h-4 bg-accent-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity shadow-lg scale-100 hover:scale-125"
                                        style={{ left: `${progress}%`, marginLeft: '-6px md:-8px' }}
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4 md:gap-6">
                                        ...
                                        <div className="flex items-center gap-2 md:gap-4">
                                            <button className="text-white/80 hover:text-white transition-colors hover:bg-white/10 p-1.5 md:p-2 rounded-lg">
                                        ...
                                        <span className="text-white/90 text-[10px] md:text-xs font-bold tracking-wider font-mono">
                                            {formatDuration(Math.floor(video.duration * progress / 100))} / {formatDuration(video.duration)}
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-2 md:gap-4">
                                        <button className="text-white/80 hover:text-accent-400 transition-colors p-1.5 md:p-2 hover:bg-white/10 rounded-lg">
