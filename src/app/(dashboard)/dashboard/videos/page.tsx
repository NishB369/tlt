...
import { Search, Grid, List, BookOpen, Video as VideoIcon } from 'lucide-react';
    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-7xl mx-auto">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-500 font-medium">Watch expert video tutorials on English literature</p>
            </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="relative group">
                        <select
                            ...
                            className="appearance-none pl-4 pr-10 py-3 bg-white border-2 border-dashed border-gray-200 rounded-lg text-sm font-bold text-gray-700 focus:outline-none focus:border-accent-500 focus:ring-0 transition-all cursor-pointer hover:border-gray-300"
                        >
                    ...
                    {/* View Toggle */}
                    <div className="flex items-center gap-1 p-1 bg-white border-2 border-dashed border-gray-200 rounded-lg">
                        <button
            ...
            {/* Videos Grid/List */}
            {selectedNovel === 'all' ? (
                // Grouped by Novel View
                (Object.entries(videosByNovel) as [string, Video[]][]).map(([novel, videos]) => (
                    <div key={novel} className="space-y-6">
                        <div className="flex items-center gap-3 border-b-2 border-dashed border-gray-100 pb-4">
                            <div className="p-2 rounded-lg bg-accent-50 text-accent-500">
                                <BookOpen className="w-5 h-5" />
                            </div>
                            <div>
                                <h2 className="text-lg font-black text-gray-900 tracking-tight">{novel}</h2>
