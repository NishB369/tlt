                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            {relatedVideo && (
                                <Link
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-blue-700 rounded-lg border border-dashed border-blue-200 hover:bg-blue-100 hover:border-blue-300 transition-all text-xs font-bold uppercase tracking-wider"
                                >
